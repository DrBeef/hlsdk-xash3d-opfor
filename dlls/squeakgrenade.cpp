...
void CSqueak::Throw(Vector throwVelocity)
{
	if( m_pPlayer->m_rgAmmo[m_iPrimaryAmmoType] ) {
        ...
        flags = 0;
#endif
        PLAYBACK_EVENT_FULL(flags, m_pPlayer->edict(), m_usSnarkFire, 0.0, g_vecZero, g_vecZero,
                            0.0, 0.0, 0, 0, 0, 0);
        ...
        CBaseEntity *pSqueak = CBaseEntity::Create("monster_snark", vecSrc, Vector(0, 0, 0),
                                                   m_pPlayer->edict());
